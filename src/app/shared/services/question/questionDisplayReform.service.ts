...
export class QuestionDisplayReformService {
    ...
    private generateDisplayContent(questionService, content) {
        ...
        const userAttemptData = _.get(content, 'userAttemptData', null);
        ...
        if (matches && matches[i]) {
            ...
            if (this.from === 'topics') {
                if (ques_type.toLowerCase() === 'blank') {
                    param = 'id="' + match + '" name="' + match + '" value="' + this.userAnswer[i] + '"class="'
                    ...
                    param = 'id="' + match + '" name="' + match + '" selected="' + this.userAnswer[i] + '"class="'
                        + thisFieldAnswerStatus + '"';
                }
            }
